...
class VideoPlayerApi {
  Future<void> initialize(InitializeMessage message) async {
    final Map<dynamic, dynamic> requestMap = message._toMap();
    const BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.VideoPlayerApi.initialize', StandardMessageCodec());
    final Map<Object?, Object?>? replyMap =
        await channel.send(requestMap) as Map<Object?, Object?>?;
    if (replyMap == null) {
